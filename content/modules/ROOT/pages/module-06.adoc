...
Now that we know what our demo environment looks like and you have started the OVN environment, let's get into the first exercise! If you have any issues or questions, let us know.
