...
At it's peak, the cluster was exceeding 1200 API requests per second.
...
2. We see 15%+ of our API traffic coming from *crunchy* / *postgress* related pods.
3. We see another 17%+ of our API traffic coming from *PersistentVolumes* and *PersistentVolumeClaims*.
