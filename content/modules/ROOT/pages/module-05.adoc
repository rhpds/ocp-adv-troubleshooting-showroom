...
[source,bash]
----
etcd-ocp-diag.py --path module5-must-gather.6521552859184261155/ --stats
...
[source,bash]
----
etcd-ocp-diag.py --path module5-must-gather.6521552859184261155/ --errors
...
[source,bash]
----
etcd-ocp-diag.py --path module5-must-gather.6521552859184261155/ --ttl | sort -u -k3,3nr
...
[source,bash]
----
etcd-ocp-diag.py --path module5-must-gather.6521552859184261155/ --ttl --date 2024-08-14 --pod etcd-prodshift-2nvq7-master-1 | sort -k3,3rn
...
[source,bash]
----
etcd-ocp-diag.py --path module5-must-gather.6521552859184261155/ --ttl --compare
...
[source,bash]
----
etcd-ocp-diag.py --path module5-must-gather.6521552859184261155/ --ttl --date 2024-07-28 --compare
