...
The Insights Operator collects Control Plane node logs that follow the following substrings: link:https://github.com/openshift/insights-operator/blob/master/pkg/gatherers/clusterconfig/gather_node_logs.go#L23-L36[Control Plane Node Logs]
