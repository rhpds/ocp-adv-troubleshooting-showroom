...
[source,bash]
----
$ ocp_insights.py --cluster_info --file ~/Module3/Cluster_1/insights.tar.gz
...
[TIP]
=====
The total memory returned, is the memory available to the Kubelet and not the physical amount of memory on the node.
=====

[source,bash]
----
ocp_insights.py --node_info --file ~/Module3/Cluster_2/insights.tar.gz
...
[source,bash]
----
$ ocp_insights.py --cluster_operators --file ~/Module3/Cluster_2/insights.tar.gz

Cluster Operators:

NAME                                      VERSION  AVAILABLE  PROGRESSING  DEGRADED
authentication                            4.16.28  True       False        True
baremetal                                 4.16.28  True       False        False
cloud-controller-manager                  4.16.28  True       False        False
cloud-credential                          4.16.28  True       False        False
cluster-autoscaler                        4.16.28  True       False        False
config-operator                           4.16.28  True       False        False
console                                   4.16.28  True       False        False
control-plane-machine-set                 4.16.28  True       False        False
csi-snapshot-controller                   4.16.28  True       False        False
dns                                       4.16.28  True       False        False
etcd                                      4.16.28  True       False        False
image-registry                            4.16.28  True       False        False
ingress                                   4.16.28  True       False        False
insights                                  4.16.28  True       False        False
kube-apiserver                            4.16.28  True       False        False
kube-controller-manager                   4.16.28  True       False        False
kube-scheduler                            4.16.28  True       False        False
kube-storage-version-migrator             4.16.28  True       False        False
machine-api                               4.16.28  True       False        False
machine-approver                          4.16.28  True       False        False
machine-config                            4.16.28  True       False        False
marketplace                               4.16.28  True       False        False
monitoring                                4.16.28  True       False        False
network                                   4.16.28  True       False        False
node-tuning                               4.16.28  True       False        False
openshift-apiserver                       4.16.28  True       False        False
openshift-controller-manager              4.16.28  True       False        False
openshift-samples                         4.16.28  True       False        False
operator-lifecycle-manager                4.16.28  True       False        False
operator-lifecycle-manager-catalog        4.16.28  True       False        False
operator-lifecycle-manager-packageserver  4.16.28  True       False        False
service-ca                                4.16.28  True       False        False
storage                                   4.16.28  True       False        False
----
...
[source,bash]
----
$ ocp_insights.py --events --file ~/Module3/Cluster_2/insights.tar.gz
...
[source,bash]
----
$ ocp_insights.py --customer_memory --file ~/Module3/Cluster_2/insights.tar.gz
...
[source,bash]
----
$ ocp_insights.py --etcd_metrics --file ~/Module3/Cluster_4/insights.tar.gz
...
[source,bash]
----
ocp_insights.py --file ../Module3/Cluster_4/insights.tar.gz
...
Install Plans:
