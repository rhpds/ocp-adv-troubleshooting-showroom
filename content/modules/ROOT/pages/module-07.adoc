...
These *outports* correspond to *portgroups* and are created for every *NetworkPolicy* in your cluster. All pods selected by the *podSelector* of that *NetworkPolicy* are added to the *portgroup* port list.
