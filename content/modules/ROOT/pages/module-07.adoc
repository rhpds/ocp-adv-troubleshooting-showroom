...
Each *outport* corresponds to a *portgroup* and one is created for every unqiue *NetworkPolicy* in your cluster. Every pod selected by the *podSelector* of that *NetworkPolicy* is added to the *portgroup* port list.
